...
$else$
$if(signature-vspace)$
% Remove distance between the closing phrase and signature if signature
% is missing: https://tex.stackexchange.com/a/68496
\renewcommand{\closing}[1]{\par\nobreak\vspace{\parskip}%
  ...
  \parbox{\indentedwidth}{\raggedright
       \ignorespaces #1\\[$signature-vspace$]%
       \ifx\@empty\fromsig
           \fromname
...
% Use sectioning, adapted from:
% https://tex.stackexchange.com/a/163860 and
% https://www.tug.org/svn/texlive/trunk/Master/texmf-dist/tex/latex/base/report.cls
\newcounter{section}
